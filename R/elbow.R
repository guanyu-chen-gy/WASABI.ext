...
#' @param loss Character, the type of loss function to use. Options are "VI" (default), "Binder", and "omARI". The choice of loss function affects the Wasserstein distance calculation.
#'
