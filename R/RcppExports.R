...
Binder_compute_Rcpp <- function(c1, c2, K1, K2) {
    .Call(`_WASABI_ext_Binder_compute_Rcpp`, c1, c2, K1, K2)
}
...
Binder_Rcpp <- function(cls1, cls2, K1s, K2s) {
    .Call(`_WASABI_ext_Binder_Rcpp`, cls1, cls2, K1s, K2s)
}
...
VI_compute_Rcpp <- function(c1, c2, K1, K2) {
    .Call(`_WASABI_ext_VI_compute_Rcpp`, c1, c2, K1, K2)
}
...
VI_Rcpp <- function(cls1, cls2, K1s, K2s) {
    .Call(`_WASABI_ext_VI_Rcpp`, cls1, cls2, K1s, K2s)
}
