...
#'
#' @usage WASABI_multistart.ext(cls.draw = NULL, psm = NULL, multi.start = 10, ncores = 1,
...
#'                                 method.init = "topvi", method = "salso")
#' }
WASABI_multistart.ext <- function(cls.draw = NULL, psm = NULL, multi.start = 10, ncores = 1,
