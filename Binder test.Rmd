...
p1 <- ggplot(df)+
  ...
  theme_bw() + ggtitle("salso estimate for a = 1.065")
```
...
p2 <- ggplot(df)+
  geom_point(aes(x = x1, y = x2, color = Cluster, shape = Cluster)) +
  ylab(expression("x"[2]))+xlab(expression("x"[1]))+
  theme_bw() + ggtitle("salso estimate for a = 1.13")
```
...
plot(out_elbow$wass_vec, type = "b", ylab = "Wass distance", xlab = "Number of particles", main = " a = 1.065")
```
...
plot(out_elbow$wass_vec, type = "b", ylab = "Wass distance", xlab = "Number of particles", main = " a = 1.13")
```
...
plot(out_elbow$wass_vec, type = "b", ylab = "Wass distance", xlab = "Number of particles", main = " a = 1.17 ")
```
...
plot(out_elbow$wass_vec, type = "b", ylab = "Wass distance", xlab = "Number of particles", main = "a = 1.3")
```
...
plot(out_elbow$wass_vec, type = "b", ylab = "Wass distance", xlab = "Number of particles", main = " a = 1.5 ")
```
